...
Eigen::Matrix4f ForwardKinematics::matrixExp(Eigen::Matrix4f epsilon,
...
Eigen::Matrix4f ForwardKinematics::getEpsilon(Eigen::Vector3f omega,
		Eigen::Vector3f q) {
...
void ForwardKinematics::fingerFK(Finger::Pose &finger, Finger::Config config,
	...
	eps[2] = getEpsilon(Eigen::Vector3f::UnitY(),
			Eigen::Vector3f(0, 0, length[0]));
	eps[3] = getEpsilon(Eigen::Vector3f::UnitY(),
